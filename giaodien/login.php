                            ...
                            <div class="panel-body">
                                ...
                                <form method="post" action="">
                                    <div class="form-group">
                                        <input id="m" type="text" class="form-control" name="username" placeholder="Username" onclick="clearerror()">
                                    </div>
                                    
                                    
                                    <div class="form-group">
                                        <input id="p" type="password" class="form-control" name="password" placeholder="Password" onclick="clearerror()">
                                    </div>
